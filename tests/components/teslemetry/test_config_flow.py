...
async def test_reconfigure(hass: HomeAssistant, mock_metadata: AsyncMock) -> None:
    ...
    result1 = await mock_entry.start_reconfigure_flow(hass)

    assert result1["type"] is FlowResultType.FORM
    assert result1["step_id"] == "reconfigure_confirm"
    assert not result1["errors"]
...
async def test_reconfigure_errors(
    ...
    """Test reconfigure flows that fail."""
